...
const content = {
  zh: {
    ...
    playbackNotice: '受限于浏览器播放器，所有在线音频展示可能存在杂音瑕疵。请下载 WAV 后使用 Windows 媒体播放器播放，以获得更佳音质。',
    downloadWav: '下载 WAV',
  ...
  en: {
    ...
    playbackNotice: 'Browser playback may introduce audible noise into all online audio previews. For better quality, download the WAV and play it with Windows Media Player.',
